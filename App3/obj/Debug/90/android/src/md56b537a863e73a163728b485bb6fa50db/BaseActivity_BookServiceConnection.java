...
public class BaseActivity_BookServiceConnection
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App3.BaseActivity+BookServiceConnection, App3", BaseActivity_BookServiceConnection.class, __md_methods);
	}


	public BaseActivity_BookServiceConnection ()
	{
		super ();
		if (getClass () == BaseActivity_BookServiceConnection.class)
			mono.android.TypeManager.Activate ("App3.BaseActivity+BookServiceConnection, App3", "", this, new java.lang.Object[] {  });
	}
