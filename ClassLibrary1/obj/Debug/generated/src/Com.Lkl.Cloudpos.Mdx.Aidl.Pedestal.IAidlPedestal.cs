...
#pragma warning restore 0169
	...
	public partial interface IAidlPedestal : global::Android.OS.IInterface {
		...
		bool IsCoupled {
			...
			[Register ("isCoupled", "()Z", "GetIsCoupledHandler:Com.Lkl.Cloudpos.Mdx.Aidl.Pedestal.IAidlPedestalInvoker, ClassLibrary1")] get;
		}
		...
		global::Android.OS.IBinder SerialManager {
			...
			[Register ("getSerialManager", "()Landroid/os/IBinder;", "GetGetSerialManagerHandler:Com.Lkl.Cloudpos.Mdx.Aidl.Pedestal.IAidlPedestalInvoker, ClassLibrary1")] get;
		}
